...
function setPotentialScroller(containerEl, height) {
	// Esta linea se comenta ara evitar que el framework coloque escrollbar en el calendario y el alto del div que lo contiene por que esto daña la grilla del mismo.
...
Grid.mixin({
	...
	renderEvents: function(events) {
		...
		this.segs = fgSegs.concat(bgSegs);
	},
...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		if (!event.allDay && seg.isStart) {
			// se comenta esta linea para que NO muestre la hora en los eventos
