...
if($res_bus){
        ...
        while($row_bus = mysql_fetch_array($res_bus)){
            ...
            $html .= '<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 text-left cam_ing">';
                ...
                $html .= '<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left">
                            <div id="cont_'.$row_bus[0].'" class="col-xs-12 col-sm-12 col-md-12 col-lg-12 btn btn-success opc_emp">
    ...
    $html .= '<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><strong>Atención!</strong> No se encontraron resultados...</div>';
}
$html .= '</div>';
echo $html;
?>
