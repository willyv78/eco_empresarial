...
$res_bus = otrosDatos($exp_id, "e3_segsoc");
?>
            ...
            <tr>
                <th>
                    <div name="<?php echo $exp_id;?>" class="input-group input-group-md btn_est">
                        ...
                        <input type="hidden" name="input-pagina" id="input-pagina" class="form-control" value="ins_upd_seg">
                    ...
                    <tr>
                        <td>
                            <div name="<?php echo $row_bus[0];?>" class="input-group input-group-md btn_est">
                                <?php echo utf8_encode($row_bus[1]); ?>
